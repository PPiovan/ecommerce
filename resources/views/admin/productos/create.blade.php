...
<div class="max-w-3xl">
    ...
    <div class="admin-card">
        ...
        <div class="admin-card-header">
            <h3 class="admin-card-title">Creación de un nuevo producto</h3>
        </div>

        <div class="p-6">

            <form action="{{ route('admin.productos.store') }}" method="POST" enctype="multipart/form-data" class="admin-form">
                @csrf
                ...
                <div class="admin-form-group">
                    ...
                    <div class="mb-4">
                        <img
                            id="preview-imagen"
                            src="https://placehold.co/160x160?text=Preview"
